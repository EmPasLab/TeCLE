...
from networks.curiosity import IcmNatureConvNet
...
FLAGS = flags.FLAGS
flags.DEFINE_string('environment_name', 'BankHeist', 'Atari name without NoFrameskip and version, like Breakout, Pong, Seaquest.')
...
flags.DEFINE_string('results_csv_path', './logs/ppo_icm_BankHeist_results.csv', 'Path for CSV log file.')
