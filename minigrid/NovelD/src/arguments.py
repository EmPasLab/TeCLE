...
parser.add_argument('--seed', default=98, type=int,
                    help='Environment seed.')
parser.add_argument('--save_interval', default=10, type=int, metavar='N',
                    help='Time interval (in minutes) at which to save the model.')    
parser.add_argument('--checkpoint_num_frames', default=100000, type=int,
...
parser.add_argument('--unroll_length', default=128, type=int, metavar='T',
...
parser.add_argument('--Noisy_TV', required=True, help='If True, Nosiy TV states are appear')
...
parser.add_argument('--inverse_loss_coef', default=0.1, type=float,
                    ...
                    This weighs the inverse model loss agains the forward model loss. \
                    Should be between 0 and 1.')
parser.add_argument('--intrinsic_reward_coef', default=0.05, type=float,
